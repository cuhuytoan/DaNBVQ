...
{
    public class Accesories_Search_Result
    {
        [Key]
        public Nullable<long> NoItem { get; set; }
        public Nullable<int> TotalRows { get; set; }
        public int TotalRowsSaveDraft { get; set; }
        public int TotalRowsWaitApproval { get; set; }
        public int TotalRowsInfoError { get; set; }
        public int TotalRowsPublised { get; set; }
        public int TotalRowsStopPublised { get; set; }
