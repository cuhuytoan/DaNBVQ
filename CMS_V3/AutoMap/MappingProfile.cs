...
namespace CMS_V3.AutoMap
{
    public class MappingProfile: Profile
    {
        public MappingProfile()
        {
            ...
            CreateMap<ListAdvertisingCarouselDTO, JObject>().ReverseMap();
            CreateMap<ListAdvertisingCarouselDTOTest, JObject>().ReverseMap();
            //Profile
            ...
            CreateMap<ArticleShortInfo, ArticleDTO>().ReverseMap();
            ...
            CreateMap<ProductManufacture_SearchByCategory_Result, ProductManufacture_SearchByCategory_Result_DTO>().ReverseMap();
